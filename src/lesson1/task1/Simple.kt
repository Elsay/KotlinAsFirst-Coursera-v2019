 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg + (min + sec.toDouble() / 60) / 60) * PI / 180
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    var totalAmount: Double = initial.toDouble()
    (1..3).forEach { totalAmount += totalAmount * percent / 100 }
    return totalAmount
}
